  ...
  return {
    ...
    information: {
      ...
      shippingInformationSample: {
        sameAsBillingInformation: specification.information?.shipping_information_sample?.same_as_billing_information || false,
        addressLine1: specification.information?.shipping_information_sample?.address_line_1 || "",
        addressLine2: specification.information?.shipping_information_sample?.address_line_2 || "",
        zipCode: specification.information?.shipping_information_sample?.zip_code || "",
        state: specification.information?.shipping_information_sample?.state || "",
        city: specification.information?.shipping_information_sample?.city || "",
        country: specification.information?.shipping_information_sample?.country || "",
        companyName: specification.information?.shipping_information_sample?.company_name || "",
        firstName: specification.information?.shipping_information_sample?.first_name || "",
        lastName: specification.information?.shipping_information_sample?.last_name || "",
        phoneNumber: specification.information?.shipping_information_sample?.phone_number || "",
        email: specification.information?.shipping_information_sample?.email || "",
      },
      shippingInformationMainProduction: {
        sameAsShippingInformationSample: specification.information?.shipping_information_main_production?.same_as_shipping_information_sample || false,
        addressLine1: specification.information?.shipping_information_main_production?.address_line_1 || "",
        addressLine2: specification.information?.shipping_information_main_production?.address_line_2 || "",
        zipCode: specification.information?.shipping_information_main_production?.zip_code || "",
        state: specification.information?.shipping_information_main_production?.state || "",
        city: specification.information?.shipping_information_main_production?.city || "",
        country: specification.information?.shipping_information_main_production?.country || "",
        companyName: specification.information?.shipping_information_main_production?.company_name || "",
        firstName: specification.information?.shipping_information_main_production?.first_name || "",
        lastName: specification.information?.shipping_information_main_production?.last_name || "",
        phoneNumber: specification.information?.shipping_information_main_production?.phone_number || "",
        email: specification.information?.shipping_information_main_production?.email || "",
      }
    }
  };
}
