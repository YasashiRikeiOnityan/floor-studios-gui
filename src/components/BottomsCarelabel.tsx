...
type BottomsCarelabelProps = {
  callBackUpdateState: () => void;
  isUpdateProgress: boolean;
};

const BottomsCarelabel = observer((props: BottomsCarelabelProps) => {
  ...
  const handleSaveAndNext = async () => {
    setIsSaving(true);
    const body = {
      ...(props.isUpdateProgress && { progress: "CARELABEL" }),
      care_label: {
        description: {
  ...
  const handleCancel = () => {
    setDescription(currentSpecification.careLabel?.description || {
      description: "",
      file: undefined,
    });
  };
  ...
  return (
    <>
      ...
      <h1 className="mt-1 text-lg sm:text-2xl font-bold tracking-tight text-gray-900">Care Label</h1>
      <div className="mt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
          ...
          <textarea
            ...
            placeholder="Enter care label description..."
          />
            ...
            <div className="flex items-center gap-x-3">
              <div className="flex items-center space-x-3">
                ...
                {!description.file && <label
                  htmlFor="care-label-image-upload"
...
export default BottomsCarelabel;