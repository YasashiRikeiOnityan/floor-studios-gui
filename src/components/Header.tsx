        ...
        <div className="flex h-16 justify-between">
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            ...
            <Menu as="div" className="relative ml-3">
              <div>
                <MenuButton className="relative flex max-w-xs items-center rounded-full bg-white text-sm hover:cursor-pointer">
                  <span className="absolute -inset-1.5" />
                  <span className="sr-only">Open user menu</span>
                  <img alt="" src="/userIcon.svg" className="size-8 rounded-full" />
                </MenuButton>
              </div>
              <MenuItems
                transition
      ...
      <DisclosurePanel className="sm:hidden">
        ...
        <div className="border-t border-gray-200 pb-3 pt-4">
          <div className="flex items-center px-4">
            ...
            <div className="ml-3">
              <div className="text-base font-medium text-gray-800">{signInUserStore.getUser().userName}</div>
              <div className="text-sm font-medium text-gray-500">{signInUserStore.getUser().email}</div>
            </div>
            {/* <button
              type="button"
