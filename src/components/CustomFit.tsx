    ...
    <>
      ...
      <div className="space-y-6 mt-4">
        <div className="flex justify-evenly items-start">
          ...
          {currentSpecification?.type === "JACKET" && <img src="/jacket.jpg" alt="tops-fit" className="w-90" />}
          {currentSpecification?.type === "HEAVY_OUTER" && <img src="/heavy_outer.jpg" alt="tops-fit" className="w-90" />}
        </div>
      </div>
      {/* ボタン */}
