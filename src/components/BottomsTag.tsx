...
type BottomsTagProps = {
  callBackUpdateState: () => void;
  isUpdateProgress: boolean;
};

const BottomsTag = observer((props: BottomsTagProps) => {
  const currentSpecification = specificationStore.currentSpecification as BottomsSpecification;

  const [description, setDescription] = useState(currentSpecification.tag?.description || {
    description: "",
    file: undefined,
  });
  ...
  const handleCancel = () => {
    setDescription(currentSpecification.tag?.description || {
      description: "",
      file: undefined,
    });
  };
  ...
  return (
    <>
      ...
      <h1 className="mt-1 text-lg sm:text-2xl font-bold tracking-tight text-gray-900">Tag</h1>
      <div className="mt-6">
