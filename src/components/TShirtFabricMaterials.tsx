...
const TShirtFabricMaterials = observer((props: TShirtFabricMaterials) => {
  ...
  const currentMaterial = materials.find(material => material.rowMaterial === props.currentMaterial);

  return (
    <Listbox value={props.currentMaterial} onChange={props.setCurrentMaterial} as="div" className="relative">
